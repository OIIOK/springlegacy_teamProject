...
<body>
	...
	<div class="container" id="container">
		...
		<!-- 페이지제목 -->
		<div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; "padding: 25px 0 0 0">
                <p class="section-title bg-white text-center text-primary px-3">ECOECO</p>
                <a href="#"><h1 class="mb-5">에코수다</h1></a>
            </div>
		<!-- 페이지제목 -->
		...
		<!-- 표  -->
		<div class="container">
			<h3 class="card-title" style="padding: 50px 0 25px 0">목록</h3>
