 ...
 * Generated at: 2023-04-29 15:39:24 UTC
...
public final class sharingDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.friendly.eco.domain.SharingApplicant");
...
if(session.getAttribute("mem")==null){
      ...
      out.write("    			<div class=\"col-lg-6 mb-5 ftco-animate fadeInUp ftco-animated\">\r\n");
      out.write("    				<img src=\"/resources/data/community/sharing/");
      out.print(sharing.getSharing_thumbnail());
      out.write("\" id=\"thumbnail\" alt=\"Colorlib Template\">\r\n");
      out.write("    			</div>\r\n");
      out.write("    			<div class=\"col-lg-1 product-details pl-md-5 ftco-animate fadeInUp ftco-animated\">\r\n");
      out.write("    			</div>\r\n");
      out.write("    			<div class=\"col-lg-5 product-details pl-md-5 ftco-animate fadeInUp ftco-animated\">\r\n");
      out.write("    				<input type=\"hidden\" name=\"sharing_idx\" value=\"");
      out.print(sharing.getSharing_idx());
      out.write("\">\r\n");
      out.write("    				<input type=\"hidden\" name=\"mem_idx\" value=\"");
      out.print(sharing.getSharing_idx());
      out.write("\">\r\n");
      out.write("    				<input type=\"hidden\" name=\"sharing_random_range\" value=\"");
      out.print(sharing.getSharing_random_range());
      out.write("\">\r\n");
      out.write("    				<h4 style=\"padding: 0px 0px 10px 0px;\">");
      out.print(sharing.getSharing_productname() );
      out.write("</h4>\r\n");
      out.write("    				<h5 style=\"padding: 0px 0px 10px 0px;\">작성자 올 곳</h5>\r\n");
      out.write("    				<div class=\"row\" style=\"padding: 0px 0px 15px 0px;\">\r\n");
      out.write("    					<div class=\"col-6\"><div >등록일 : ");
      out.print(sharing.getSharing_regdate());
      out.write("</div></div>\r\n");
      out.write("    					<div class=\"col-6\"><label >조회수 : ");
      out.print(sharing.getSharing_hits() );
      out.write("</label></div>\r\n");
      out.write("    				</div>\r\n");
      out.write("    				<div style=\"border: 1px solid; padding:10px; margin:20px 0 50px 0 ;\" id=\"detail\">\r\n");
      out.write("    					");
      out.print(sharing.getSharing_detail() );
      out.write("\r\n");
      out.write("    				</div>\r\n");
      out.write("    			</div>\r\n");
      out.write("    			<!-- 버튼 -->\r\n");
      out.write("                        <div class=\"col \" align=\"right\" style=\"padding: 0px 15px 100px 0px;\">\r\n");
      out.write("                            <div class=\"btn-group\" role=\"group\" aria-label=\"기본 예\">\r\n");
      out.write("                                <button type=\"button\" class=\"btn btn-danger\" id=\"bt_apply\">\r\n");
      out.write("                                    <font style=\"vertical-align: inherit;\">\r\n");
      out.write("                                        <font style=\"vertical-align: inherit;\">신청하기</font>\r\n");
      out.write("                                    </font>\r\n");
      out.write("                                </button>\r\n");
      ...
      out.write("                      <div class=\"card-header d-block\">\r\n");
      out.write("                          <h5 class=\"card-title\">신청자 목록</h5>\r\n");
      out.write("                      </div>\r\n");
      out.write("                      <div class=\"card-body\">\r\n");
      out.write("                          <!-- 버튼 한 줄 -->\r\n");
      out.write("	                      <!-- 3) sharingApplicantList에 담긴 목록 수만큼 row를 생성함 (idx와 json이 키,값으로 채워짐)-->\r\n");
      out.write("	                       <template v-for=\"json in sharingApplicantList\">\r\n");
      out.write("	                       	<row :key=\"json.applicant_idx\" :obj=\"json\"/>\r\n");
      out.write("	                      </template>\r\n");
      out.write("                          <!-- 버튼 한 줄 -->\r\n");
      out.write("                      </div>\r\n");
      out.write("                  </div>\r\n");
      ...
      out.write("	\r\n");
      out.write("	let form2;\r\n");
      out.write("	//let applicantIdx;\r\n");
      out.write("	//let randomIndex;\r\n");
      out.write("	let sharingRandomIndex;\r\n");
      out.write("	let win=0; //기본값0=낙첨, 1=당첨\r\n");
      out.write("	\r\n");
      out.write("	//template으로 반복문 처리함\r\n");
      out.write("	const row={\r\n");
      out.write("			template:`\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=\"hidden\" name=\"applicant_idx\" value=\"sharingApplicant.applicant_idx\" >\r\n");
      out.write("				<button type=\"button\" class=\"btn btn-outline-dark\"  id=\"bt_applicant_idx\" style=\"margin :  5px 5px 5px 5px\" v-on:click=\"applyForm(sharingApplicant.applicant_idx)\">닉네임</button>\r\n");
      out.write("			</div>\r\n");
      out.write("			`, \r\n");
      out.write("			//4) row 인스턴스 생성 시 외부에서 전달되는 파라미터(json에 담긴 sharingApplicant)를 받아와 data로 나타냄\r\n");
      out.write("			props:['obj'],\r\n");
      out.write("			data(){\r\n");
      out.write("				return{\r\n");
      out.write("					sharingApplicant:this.obj\r\n");
      out.write("				};\r\n");
      out.write("			},\r\n");
      out.write("			methods:{\r\n");
      out.write("				applyForm(idx){\r\n");
      out.write("					alert(\"신청번호 : \" + idx);\r\n");
      out.write("				}	\r\n");
      out.write("			}\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      ...
      out.write("		},\r\n");
      out.write("		data:{\r\n");
      out.write("			sharingApplicantList:[]\r\n");
      out.write("		}\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	//삭제하기\r\n");
      ...
      out.write("\r\n");
      out.write("		console.log(\"선택한 글번호 : \", $(\"#form1 input[name='sharing_idx']\").val());\r\n");
      out.write("\r\n");
      out.write("		//삭제 확인하기\r\n");
      ...
      out.write("\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			url : \"/community/sharing/del/\"+ $(\"#form1 input[name='sharing_idx']\").val(),\r\n");
      out.write("			type : \"POST\",\r\n");
      ...
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	//당첨결과 확인하기(신청 결과 확인, 신청자 등록)\r\n");
      out.write("	function winnerCheck(){\r\n");
      out.write("		//1) 인덱스(=신청자 수) 증가시키기\r\n");
      out.write("		//2) 레코드 한 줄 가져와 랜덤범위와 인덱스(=신청자 수) 비교하기\r\n");
      out.write("		//3) 신청 정보 등록하기\r\n");
      out.write("		//let formData = new FormData();\r\n");
      out.write("		let json = {};\r\n");
      out.write("		json['sharing_idx']=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sharing.sharing_idx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(";\r\n");
      out.write("		console.log(\"sharing_idx : ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sharing.sharing_idx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\");\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			url:\"/rest/community/sharing/index\", \r\n");
      out.write("			method:\"POST\",\r\n");
      out.write("			dataType:'json',\r\n");
      out.write("			contentType: 'application/json',\r\n");
      out.write("			data:JSON.stringify(json),\r\n");
      out.write("			success:function(result, status, xhr){\r\n");
      out.write("				let resultCode = result.code; //0-낙첨, 1-당첨\r\n");
      out.write("				//console.log(\"결과 : \"+ resultCode);\r\n");
      out.write("				if(resultCode==0){\r\n");
      out.write("				alert(result.msg); //낙첨\r\n");
      out.write("				location.href = \"/community/sharingList\"\r\n");
      out.write("				} else if (resultCode==1) {\r\n");
      out.write("				alert(result.msg);\r\n");
      out.write("				location.href=\"/community/sharingWinning\"\r\n");
      out.write("				}\r\n");
      out.write("			},\r\n");
      out.write("			error:function(xhr, status, result){\r\n");
      ...
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	//신청자 목록 가져오기\r\n");
      out.write("	function saList(){\r\n");
      out.write("		\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			url:\"/rest/community/sharing/\"+ $(\"#form1 input[name='sharing_idx']\").val(),\r\n");
      out.write("			type:\"GET\",\r\n");
      out.write("			success:function(result, status, xhr){\r\n");
      out.write("				//console.log(result);\r\n");
      out.write("				form2.sharingApplicantList=result; //2) 가져오기 성공한 sharingApplicantList을 List에 담음 \r\n");
      out.write("			},\r\n");
      out.write("			error:function(xhr, status, result){\r\n");
      out.write("				console.log(\"xhr : \", xhr);\r\n");
      out.write("				console.log(\"status : \", status);\r\n");
      ...
      out.write("	//init\r\n");
      out.write("	$(function(){\r\n");
      out.write("		//1) 로드 시 신청자목록 가져오기\r\n");
      out.write("		//saList에서 로드 시 가져온 신청자목록을 sharingApplicantList에 담음\r\n");
      out.write("		//form2에서 sharingApplicantList에 담긴 목록 수만큼 row를 생성함\r\n");
      out.write("		saList(); //신청목록 가져오기\r\n");
      out.write("		\r\n");
      out.write("		//수정버튼 이벤트 연결\r\n");
      out.write("		$(\"#bt_edit\").click(\r\n");
      out.write("				function() {\r\n");
      out.write("					//수정폼 이동\r\n");
      out.write("					location.href=\"sharingEdit?sharing_idx=\"+$(\"#form1 input[name='sharing_idx']\").val();\r\n");
      out.write("				});\r\n");
      out.write("		\r\n");
      ...
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		//신청버튼 이벤트 연결\r\n");
      out.write("		$(\"#bt_apply\").click(function() {\r\n");
      out.write("			confirm(\"회원당 한 번만 신청가능합니다. 신청하시겠습니까?\");\r\n");
      out.write("			winnerCheck(); //당첨결과 확인하기\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("	});\r\n");
      out.write("		\r\n");
