							...
							<div class="col">
								...
								<div class="form-group row">
									<div class="col">
										...
										<input type="text" class="form-control" id="dpostscript_title" name="dpostscript_title" placeholder="제목을 입력하세요">								
									</div>
								</div>		
								...
								<div class="form-group row">
									<div class="col">
										...
										<input type="text" class="form-control" name="dpostscript_writer" placeholder="작성자 자동 세팅 예정">
									</div>
								</div>	
								...
								<div class="form-group row">
									<div class="col">
										...
										<!--써머노트 안되는거 수정하기-->
										<textarea id="summernote" name="dpostscript_detail" id="dpostscript_detail"></textarea>
									</div>
								</div>
