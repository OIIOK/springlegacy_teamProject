  ...
  <div class="jumbotron">
						...
						<div class="container">
							...
							<div class="mb-3">
								<div class="btn-group btn-group-lg mt-1">
									  <button type="button" class="btn btn-outline-success" id="bt-phone-certific">휴대폰 인증</button>
									  <button type="button" class="btn btn-success" id="bt-email-certific">이메일 인증</button>
									</div>
							</div>
							...
							<form action="/action_page.php" class="was-validated">
							    ...
							    <div class="form-group mb-5">	
							    	...
							    	<div id="div-input-email">    	
										<input type="text" class="form-control" id="pwd" placeholder="이메일주소 입력" name="pswd" required>							    	
							    	</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#bt-phone-certific").click(function() {
