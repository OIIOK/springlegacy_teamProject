							...
							<!--------------------------------------------------------------------------------------------------------------------- 
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->
							    <div class="form-group mb-5 oveflow-hidden" >
							      ...
							      <input type="password" class="form-control" id="society_mem_name" placeholder="기업/단체명 입력" name="society_mem_name" required>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="soc_name_valid">Please fill out this field.</div>
							    </div>
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->
								<div class="form-group mb-5 overflow-hidden" id="selectcon">
							    	...
							    	<div id="div-input-email">    	
										<input type="text" class="form-control" placeholder="사업자 등록 번호 입력" name="society_mem_registration" id="society_mem_registration" required>							    	
							    	</div>
							    	<div id="div-bt-certific">
										<button type="button" class="btn btn-outline-success" id="soc_check">기업확인</button>							      						    	
							    	</div>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="soc_regist_valid">Please fill out this field.</div>
							    </div>
							...
							<!--------------------------------------------------------------------------------------------------------------------- 
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->
							    <div class="form-group mb-5 oveflow-hidden">
							      ...
							      <input type="text" class="form-control" id="mem_name" placeholder="성명 입력" name="society_mem_clerk_name" required>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="clerk_name_valid">Please fill out this field.</div>
							    </div>
							...
							<!--------------------------------------------------------------------------------------------------------------------- 
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->    
							    <div class="form-group oveflow-hidden">	
							    	...
							    	<div id="div-input-email">    	
										<input type="text" class="form-control" placeholder="휴대폰번호 입력 ('-'제외)" name="society_mem_clerk_phone" id="society_mem_clerk_phone"required>							    	
							    	</div>
							    	<div id="div-bt-certific">
										<button type="button" class="btn btn-outline-success" id="phone_check">중복확인</button>							      						    	
							    	</div>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="clerk_phone_valid">Please fill out this field.</div>
							    </div>
							...
							<!--------------------------------------------------------------------------------------------------------------------- 
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->   
								<div class="form-group mb-3 oveflow-hidden">	
							    	...
							    	<div id="div-input-email">    	
										<input type="text" class="form-control" id="society_mem_clerk_email" placeholder="이메일주소 입력" name="society_mem_clerk_email" required>							    	
							    	</div>
							    	<div id="div-bt-certific">
										<button type="button" class="btn btn-outline-success" id="email_check">본인인증</button>							      						    	
							    	</div>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="soc_email_valid">Please fill out this field.</div>
							    </div>
							...
							<!--------------------------------------------------------------------------------------------------------------------- 
							 ...
							 ----------------------------------------------------------------------------------------------------------------------->
							    <div class="form-group mb-5 oveflow-hidden" >
							      ...
							      <input type="password" class="form-control" id="mem_pass" placeholder="8-16자의 영문 및 숫자, 특수문자를 모두 포함" name="society_mem_pass" id="society_mem_pass" required>
							      <div class="valid-feedback">Valid.</div>
							      <div class="invalid-feedback" id="pass_valid">Please fill out this field.</div>
							    </div>
							    <div class="form-group mb-5 oveflow-hidden">
							      <label for="pswd">비밀번호 확인:</label>
							      <input type="password" class="form-control" id="mem_pass_check" placeholder="8-16자의 영문 및 숫자, 특수문자를 모두 포함" name="society_mem_pass_check" id="society_mem_pass_check" required>
							      <div class="valid-feedback">Valid.</div>
	...
	<script type="text/javascript">
		...
		**********************************/
		function regist() {
			//alert("가입할거야?");
			$("#form1").attr({
				action:"/member/registerForSoc", //컨트롤러를 찾아 떠난다 
				method:"post"
			});
			$("#form1").submit();
